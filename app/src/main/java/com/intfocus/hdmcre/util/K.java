...
//  %s/mobile/%s/role/%s/analyse
  ...
  public final static String kReportMobilePath         = "%s/mobile/%s/group/%s/role/%s/reports";
  ...
  public final static String kPushMessageMobilePath        = "%s/mobile/%s/role/%s/group/%s/user/%s/message";
