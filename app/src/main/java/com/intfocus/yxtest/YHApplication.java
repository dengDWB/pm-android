...
import com.intfocus.yxtest.screen_lock.ConfirmPassCodeActivity;
...
import static com.intfocus.yxtest.util.K.kPushDeviceToken;
...
//                }
    ...
    private void copyAssetFiles(String basePath, String sharedPath) {
        try {
            ...
            String assetZipPath;
            File assetZipFile;
            String[] assetsName = {URLs.kAssets,URLs.kFonts,URLs.kImages,
                                    URLs.kIcons, URLs.kStylesheets,URLs.kJavaScripts,URLs.kBarCodeScan,
                                    URLs.kOfflinePages, URLs.kOfflinePagesHtml, URLs.kOfflinePagesImages,
                                    URLs.kOfflinePagesJavascripts, URLs.kOfflinePagesStylesheets, URLs.kAdvertisement}; //
